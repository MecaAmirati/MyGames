...
public class ControlaInterface : MonoBehaviour
{
    ...
    public ControlaJogador scriptControlaJogador;
    public Slider SliderVidaJogador;
    public GameObject PainelDeGameOver;
    public Text TextoTempoDeSobrevivencia;
    public Text TextoPontuacaoMaxima;
    public float tempoPontuacaoSalvo;
    public int quantidadeDeZumbisMortos;
    ...
    public void AjustarPontuacaoMaxima(int min, int seg)
    {
        if (Time.timeSinceLevelLoad > tempoPontuacaoSalvo)
        {
            ...
            TextoPontuacaoMaxima.text =
                string.Format("Your Best Time is {0}min and {1}s", min, seg);
        ...
        if (TextoPontuacaoMaxima.text == "")
        {
            ...
            TextoPontuacaoMaxima.text = string.Format("Your Best Time is {0}min and {1}s", min, seg);
        }
    }
